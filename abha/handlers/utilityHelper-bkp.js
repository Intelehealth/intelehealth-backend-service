 ...
 * @returns {Object} Practitioner structure
 */
function practitionerStructure(practitioner) {
    return {
        "resource": {
            "identifier": [
                {
 ...
 */
function createPatientResource(patientData) {
...
/**
 * Create organization data structure for FHIR bundle
...
async function formatCareContextFHIBundle(response) {
    ...
    return {
        ...
        "entry": [
            ...
            ...practitionerStructure(practitioner),
