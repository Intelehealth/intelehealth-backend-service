...
const connection = new Sequelize({
  ...
  models: [Specialization, Config, AuditTrail, Language, Publish, PatientRegistration, ThemeConfig, Vital, PatientVisitSummary], // Associates the models with this Sequelize instance,
});
