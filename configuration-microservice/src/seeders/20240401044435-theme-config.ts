    ...
    async (transaction) => {
      ...
      */
      await queryInterface.bulkInsert('theme_config', [
        { key: 'logo', default_value: 'assets/images/default-logo.png', value: 'assets/images/default-logo.png'},
        { key: 'thumbnail_logo', default_value: 'assets/images/default-thumbnail.png', value: 'assets/images/default-thumbnail.png'},
        { key: 'primary_color', default_value:'#2E1E91', value:'#2E1E91'},
        { key: 'secondary_color', default_value:'#2E1E91', value:'#4B39B7'},
        { 
          key: 'images_with_text', 
